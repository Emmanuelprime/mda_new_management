...
class ClassTeacher(models.Model):
    ...
    eleven = 'COM'
    twelve = 'WAEC'
    class_choices = [(seven, 'JAMB'), (eight, 'PUTME'), (nine, 'S.O.N'),
                     (ten, 'ARTS'), (eleven, 'COM'), (twelve, 'WAEC')]
    ...
    D = 'ENG-A'
    E = 'ART-A'
    section_choices = [(A, 'MED-A'), (B, 'MED-B'), (C, 'MED-C'), (D, 'ENG-A'), (E, 'ART-A')]
...
class StudentDetail(models.Model):
    ...
    parents_mobile_number = models.CharField(max_length=11, blank=True)
