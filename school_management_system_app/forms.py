...
class StaffRegistrationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'grade': forms.NumberInput(
                attrs={'class': 'form-control',
                       'placeholder': 'What do you grade Your self? 1-10'}),
            ...
            'permanent_address': forms.Textarea(
                attrs={'rows': 3, 'cols': 80, 'class': 'form-control',
                       'placeholder': 'Enter your address: eg 270 Agbani Road'
                       }),
    ...
    def clean_contact_number(self):
        ...
        if len(phone) != 11:
            raise forms.ValidationError("Mobile number should have 11 digits.")
        return phone
    ...
    def clean_email(self):
        ...
        if "@gmail.com" not in email:
            raise forms.ValidationError(
                "We accept only google mail addresses for now.")
        return email
...
class StdRegistration(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        if "@gmail.com" not in email:
            raise forms.ValidationError(
                "We accept only google mail addresses(xyz@gmail.com).")
        return email
