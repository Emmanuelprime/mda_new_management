...
@login_required
def seven(request):
    male = StudentDetail.objects.filter(standard='JAMB', gender='Male')
    female = StudentDetail.objects.filter(standard='JAMB', gender='Female')
    total = StudentDetail.objects.filter(standard='JAMB')
    all_field = StudentDetail.objects.filter(
        standard='JAMB').order_by('name')
...
@login_required
def eight(request):
    male = StudentDetail.objects.filter(standard='PUTME', gender='Male')
    female = StudentDetail.objects.filter(standard='PUTME', gender='Female')
    total = StudentDetail.objects.filter(standard='PUTME')
    all_field = StudentDetail.objects.filter(
        standard='PUTME').order_by('name')
    myFilter = StudentFilter(request.GET, queryset=all_field)
    all_field = myFilter.qs
    paginator = Paginator(all_field, 15)
    page_number = request.GET.get('page')
...
@login_required
def nine(request):
    male = StudentDetail.objects.filter(standard='S.O.N', gender='Male')
    female = StudentDetail.objects.filter(standard='S.O.N', gender='Female')
    total = StudentDetail.objects.filter(standard='S.O.N')
    all_field = StudentDetail.objects.filter(
        standard='S.O.N').order_by('name')
    myFilter = StudentFilter(request.GET, queryset=all_field)
    all_field = myFilter.qs
    paginator = Paginator(all_field, 15)
    page_number = request.GET.get('page')
...
@login_required
def ten(request):
    male = StudentDetail.objects.filter(standard='ART', gender='Male')
    female = StudentDetail.objects.filter(standard='ART', gender='Female')
    total = StudentDetail.objects.filter(standard='ART')
    all_field = StudentDetail.objects.filter(
        standard='ART').order_by('name')
    myFilter = StudentFilter(request.GET, queryset=all_field)
    all_field = myFilter.qs
    paginator = Paginator(all_field, 15)
    page_number = request.GET.get('page')
...
@login_required
def eleven(request):
    male = StudentDetail.objects.filter(standard='COM', gender='Male')
    female = StudentDetail.objects.filter(standard='COM', gender='Female')
    total = StudentDetail.objects.filter(standard='COM')
    all_field = StudentDetail.objects.filter(
        standard='COM').order_by('name')
    myFilter = StudentFilter(request.GET, queryset=all_field)
    all_field = myFilter.qs
    paginator = Paginator(all_field, 15)
    page_number = request.GET.get('page')
...
@login_required
def twelve(request):
    male = StudentDetail.objects.filter(standard='WAEC', gender='Male')
    female = StudentDetail.objects.filter(standard='WAEC', gender='Female')
    total = StudentDetail.objects.filter(standard='WAEC')
    all_field = StudentDetail.objects.filter(
        standard='WAEC').order_by('name')
    myFilter = StudentFilter(request.GET, queryset=all_field)
    all_field = myFilter.qs
    paginator = Paginator(all_field, 15)
    page_number = request.GET.get('page')
